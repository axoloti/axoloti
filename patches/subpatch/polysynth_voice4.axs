<patch-1.0>
   ...
   <obj type="mix2" sha="90ac1a48634cb998bf3d0387eb5191531d6241fe" name="p" x="440" y="0">
      <params>
         <frac32.u.map name="gain1" onParent="false" value="13.5"/>
         <frac32.u.map name="gain2" onParent="false" value="0.0"/>
      </params>
      <attribs/>
   </obj>
   ...
   <obj type="vcf3~" sha="a4c7bb4270fc01be85be81c8f212636b9c54eaea" name="vcfSaw" x="360" y="140">
      <params>
         <frac32.s.map name="pitch" value="0.0">
            <modulators>
               <modulation sourceName="velo" value="32.0"/>
            </modulators>
         </frac32.s.map>
   ...
   <obj type="square~" sha="a9d95b3235bd2822873f85c661764b006f96b59e" name="square" x="240" y="280">
      <params>
         <frac32.s.map name="pitch" onParent="true" value="-0.09999990463256836"/>
      </params>
      <attribs/>
   </obj>
   <obj type="vcf3~" sha="a4c7bb4270fc01be85be81c8f212636b9c54eaea" name="vcfSquare" x="360" y="280">
      <params>
         <frac32.s.map name="pitch" value="0.0">
            <modulators>
               <modulation sourceName="velo" value="33.0"/>
            </modulators>
         </frac32.s.map>
         <frac32.u.map name="reso" onParent="true" value="8.5"/>
      </params>
      <attribs/>
   </obj>
