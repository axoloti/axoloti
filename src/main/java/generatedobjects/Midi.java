...
public class Midi extends gentools {
    ...
    static AxoObject Create_keyb_mod() {
        ...
        o.sMidiCode = "if ((status == MIDI_NOTE_ON + %midichannel%) && (data2)) {\n"
                ...
                + "    &parent->PExModulationProd[parent->polyIndex][parent->MODULATOR_attr_name_velocity][0],\n"
                + "    NMODULATIONTARGETS,\n"
                + "    &parent->PExch[0],\n"
                + "    _velo<<20);\n"
                + "  PExModulationSourceChange(\n"
                + "    &parent->PExModulationSources[parent->MODULATOR_attr_name_note][0],\n"
                + "    &parent->PExModulationProd[parent->polyIndex][parent->MODULATOR_attr_name_note][0],\n"
                + "    NMODULATIONTARGETS,\n"
                + "    &parent->PExch[0],\n"
                + "    _note<<21);\n"
                + "} else if (((status == MIDI_NOTE_ON + %midichannel%) && (!data2))||\n"
                ...
                + "    &parent->PExModulationProd[parent->polyIndex][parent->MODULATOR_attr_name_releasevelocity][0],\n"
                + "    NMODULATIONTARGETS,\n"
                + "    &parent->PExch[0],\n"
                + "    _rvelo<<20);\n"
                + "  }\n"
