 ...
 */
public class AttributeInstanceMidiOutPort extends AttributeInstanceString<AxoAttributeMidiOutPort> {

    @Attribute(name = "selection", required = false)
    private String selection;

    AttributeInstanceMidiOutPort() {
    }

    AttributeInstanceMidiOutPort(AxoAttributeMidiOutPort attribute, AxoObjectInstance axoObj1) {
