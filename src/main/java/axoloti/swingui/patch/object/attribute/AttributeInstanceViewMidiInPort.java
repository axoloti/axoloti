...
class AttributeInstanceViewMidiInPort extends AttributeInstanceViewString {

    private DropDownComponent comboBox;

    AttributeInstanceViewMidiInPort(AttributeInstanceMidiInPort attribute, AxoObjectInstanceView axoObjectView) {
        super(attribute, axoObjectView);
        initComponents();
    }

    @Override
    public AttributeInstanceMidiInPort getDModel() {
        return (AttributeInstanceMidiInPort) super.getDModel();
    }
    ...
    public void setString(String s) {
        AttributeInstanceMidiInPort aic = getDModel();
