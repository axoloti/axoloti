 ...
 */
public class InletBool32RisingFalling extends InletBool32 {

    public InletBool32RisingFalling(String name, String description) {
        super(name, description);
    }

    public InletBool32RisingFalling() {
        super();
    }
