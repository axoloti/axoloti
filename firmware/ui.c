...
#ifndef NEWBOARD
  LCD_begin(&SPID1,60);
  palSetPadMode(PORT_BTN_NAV_UP , PAD_BTN_NAV_UP, PAL_MODE_INPUT_PULLUP );
  palSetPadMode(PORT_BTN_NAV_DOWN , PAD_BTN_NAV_DOWN, PAL_MODE_INPUT_PULLUP );
  palSetPadMode(PORT_BTN_NAV_LEFT , PAD_BTN_NAV_LEFT, PAL_MODE_INPUT_PULLUP );
  palSetPadMode(PORT_BTN_NAV_RIGHT, PAD_BTN_NAV_RIGHT, PAL_MODE_INPUT_PULLUP );
  palSetPadMode(PORT_BTN_NAV_ENTER, PAD_BTN_NAV_ENTER, PAL_MODE_INPUT_PULLUP );
  palSetPadMode(PORT_BTN_NAV_SHIFT, PAD_BTN_NAV_SHIFT, PAL_MODE_INPUT_PULLUP );
  palSetPadMode(PORT_BTN_NAV_BACK , PAD_BTN_NAV_BACK, PAL_MODE_INPUT_PULLUP );
  init_ioexpander();
#endif
